...
export const api = {
  ...
  getProjectHistory: (id: string) => request(`/projects/${id}/history`),
  ...
  updateIdea: (id: string, data: any) => request(`/ideas/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
  deleteIdea: (id: string) => request(`/ideas/${id}`, { method: 'DELETE' }),
  getIdeaHistory: (id: string) => request(`/ideas/${id}/history`),
